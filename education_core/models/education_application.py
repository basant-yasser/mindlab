...
class EducationApplication(models.Model):
    ...
    def create(self, vals):
        """Override create to assign sequence and validate email."""

        # Handle multi-record creation
        multiple = isinstance(vals, list)
        vals_list = vals if multiple else [vals]
        ...
        for v in vals_list:
            ...
            ).match(v['email']) is None:
                raise ValidationError(f"Invalid email address: {v['email']}")
